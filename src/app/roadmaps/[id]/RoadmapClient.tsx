...
import { ArrowLeft, Clock, BrainCircuit, CheckCircle2 } from "lucide-react";
  ...
  return (
    <LayoutContainer className="py-6 md:py-10 space-y-6 md:space-y-10 overflow-hidden sm:overflow-visible">
      <div className="max-w-4xl mx-auto w-full">
        <Link href="/roadmaps" className={buttonVariants({ variant: "ghost", className: "mb-2 md:mb-4 inline-flex items-center gap-2" })}>
