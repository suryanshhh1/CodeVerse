...
export function NavbarClient({ session, signOutAction }: { session: unknown, signOutAction: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <LayoutContainer size="wide" offset="none" className="flex items-center justify-between h-16 w-full">
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            <form action="/search" method="GET" className="relative hidden lg:block w-48 group">
